...
# Tracker reports picks from the current model version only — a fresh start as of
# the v7-weather-cal2-0.3.0 launch (2026-07-01). Earlier picks were generated by a
# different model, so their CLV/ROI would muddy this version's track record.
TRACKER_START_DATE = _date(2026, 7, 1)
